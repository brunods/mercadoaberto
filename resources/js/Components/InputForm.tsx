...
export default function InputForm({
    ...
    return (
        <>
            ...
            <input
                className={`
                    w-full rounded-[4px] border-[1px] border-gray-200 py-2 pl-14 mb-[5px] font-inter text-sm text-gray-600 ${type === 'password' ? 'pr-14' : 'pr-3'}
            ...
            {type === 'password' ?
                <div className="
                    w-fit relative ml-auto mr-[18px] mt-[-33px] mb-5 cursor-pointer
